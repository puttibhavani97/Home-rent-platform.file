...
from .views import property_list, post_property, index, login_view, signup_view, logout_view, get_contact_details,payment_view, process_payment, about_us, redirect_about, index
